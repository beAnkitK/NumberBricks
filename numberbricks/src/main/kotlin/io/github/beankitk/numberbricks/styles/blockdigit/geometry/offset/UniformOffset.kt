 ...
 *
 * This [OffsetProvider] returns the same offset for every block for a given
 * digit. This can be used for geometry where all blocks share a common
 * coordinate in the grid. The provided [Offset] must be defined in grid-relative
 * fractional units, where `1f` represents the size of a single grid cell.
 *
