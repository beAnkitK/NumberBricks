 ...
 *
 * A [CornerProfile] holds the computed [CornerType] for each of the four corners of a rectangle
 * after spatial analysis against neighboring rectangles. Used by
 * [io.github.beankitk.numberbricks.utils.CornerDetector] that inspects how rectangles intersect or
 * align in a layout.
 *
