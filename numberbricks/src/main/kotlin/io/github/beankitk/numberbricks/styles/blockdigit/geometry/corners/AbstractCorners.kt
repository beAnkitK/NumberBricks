...
/**
 * Provides a [CornersProvider] that applies corner styling for digit geometry
 * based on [AbstractPosition].
 *
 * This extends [AutoCornersProvider] and applies styles to selected
 * [CornerType] classifications including [CornerType.Outer],
 * [CornerType.CornerNeighbor], [CornerType.Corner], and [CornerType.Joint].
 * All other corner types remain unstyled.
 *
 * By default, all styles are set to [CornerStyle.None], resulting in no corner
 * styling across blocks (similar to [UniformCorners.Sharp]). For completely
 * sharp corners or square blocks, prefer using [UniformCorners.Sharp] directly.
 *
 * Predefined styles:
...
class AbstractCorners(
    ...
    /**
     * Creates an [AbstractCorners] provider with corner radius values for key
     * corner types and a common shape.
     *
    ...
    companion object {
        ...
        /**
         * Creates a retro-style corner appearance for abstract digit geometry similar to [RetroCorners].
         *
