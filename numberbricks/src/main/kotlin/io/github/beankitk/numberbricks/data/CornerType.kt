 ...
 *
 * When rectangles are arranged in a grid with overlapping edges, each corner can have up to three
 * types of neighbors:
 *
 ...
 *
 * The corner type describes the structural role of that corner in the overall brick formation,
 * which determines appropriate styling like corner rounding.
 */
@JvmInline
value class CornerType private constructor(val ordinal: Int) {
    ...
    companion object {
         ...
         *
         * This corner is near a point where two rectangles touch diagonally, affecting how it
         * should be styled to maintain visual consistency with the connection.
         */
         ...
         *
         * This represents a corner-to-corner connection where rectangles meet at a single point
         ...
         * - Has either horizontal or vertical neighbor, but not both
         *
         * This corner is adjacent to a junction point, forming part of the connection structure but
         * not serving as the central meeting point.
         */
         ...
         * - No diagonal neighbor
         *
         * This corner forms a L-junction where rectangles connect along their edges without
         * diagonal overlap.
         */
         ...
         *
         * This is an internal corner completely surrounded by the brick formation, typically
         * occurring in the middle of densely packed grids.
         */
            ...
            when (ordinal) {
                ...
                6 -> Inner
                    ...
                    throw IllegalArgumentException(
                        "Unknown ordinal value = $ordinal for CornerType"
                    )
            }
    }
}
