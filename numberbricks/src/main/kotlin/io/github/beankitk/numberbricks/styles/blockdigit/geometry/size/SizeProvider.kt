 ...
 *
 * A [SizeProvider] is a [GeometryProvider] responsible for providing the
 * [Size] of each block for a given digit. The produced values are used during
 * block assembly to construct the final brick model.
 *
 * Implementations must provide sizes as grid-relative fractional values,
