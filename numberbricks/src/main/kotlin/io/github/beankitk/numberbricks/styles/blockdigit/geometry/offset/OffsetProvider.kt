 ...
 *
 * An [OffsetProvider] is a [GeometryProvider] responsible for defining the
 * rendered position (top-left offset) of each block relative to the digit origin.
 * The produced values are used during block assembly to construct the final
 * brick model.
 *
 * Implementations must provide offsets as grid-relative fractional values,
 * where `1f` represents the size of a single grid cell.
 *
