...
/**
 * An adaptive offset provider that derives blocks offset directly from their grid positions
 ...
 * cells. It is the simplest position-to-offset mapping, useful when the blocks needs to be aligned
