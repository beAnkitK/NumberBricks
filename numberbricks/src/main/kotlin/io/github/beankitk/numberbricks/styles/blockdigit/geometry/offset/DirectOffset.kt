 ...
 *
 * This [OffsetProvider] converts each block’s [Position] into an [Offset] in
 * grid-relative fractional units, where `1f` represents one grid cell as defined
 * in [Block]. The column maps to the x-axis and the row maps to the y-axis.
 *
 * This results in a direct cell-aligned placement, where each block is positioned
 * at the origin of its grid cell without any additional adjustments.
 *
